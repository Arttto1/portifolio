        ...
        <header>
          <nav>
            <ul className="list-none font-bold text-2xl md:text-3xl flex justify-center gap-8">
              <li
                className={`-translate-y-[100px] opacity-0 ${path.startsWith("/projetos") ? "nav-geral" : ""}`}
              >
                <NavLink href={"/geral"}>Geral</NavLink>
              </li>
              <li
                className={`-translate-y-[100px] opacity-0 ${path.startsWith("/projetos") ? "nav-projetos" : ""}`}
              >
                <NavLink href={"/projetos"}>Projetos</NavLink>
              </li>
              <li
                className={`-translate-y-[100px] opacity-0 ${path.startsWith("/projetos") ? "nav-serviços" : ""}`}
              >
                <NavLink href={"/servicos"}>Serviços</NavLink>
              </li>
              <li
                className={`-translate-y-[100px] opacity-0 ${path.startsWith("/projetos") ? "nav-contato" : ""}`}
              >
