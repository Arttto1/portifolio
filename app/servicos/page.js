        ...
        <header>
          <nav>
            <ul className="list-none font-bold text-2xl md:text-3xl flex justify-center gap-8">
              <li
                className={`-translate-y-[100px] opacity-0 ${path.startsWith("/servicos") ? "nav-geral" : ""}`}
              >
                <NavLink href={"/geral"}>Geral</NavLink>
              </li>
              <li
                className={`-translate-y-[100px] opacity-0 ${path.startsWith("/servicos") ? "nav-projetos" : ""}`}
              >
                <NavLink href={"/projetos"}>Projetos</NavLink>
              </li>
              <li
                className={`-translate-y-[100px] opacity-0 ${path.startsWith("/servicos") ? "nav-serviços" : ""}`}
              >
                <NavLink href={"/servicos"}>Serviços</NavLink>
              </li>
              <li
                className={`-translate-y-[100px] opacity-0 ${path.startsWith("/servicos") ? "nav-contato" : ""}`}
              >
